		...
		<view :class="{ 'uni-navbar--fixed': fixed, 'uni-navbar--shadow': shadow, 'uni-navbar--border': border }" :style="{ 'background-color': backgroundColor }"
		 class="uni-navbar__content">
			...
			<view :style="{ color: color,backgroundColor: backgroundColor }" class="uni-navbar__header uni-navbar__content_view">
				...
				<view :class="{'uni-navbar__header-btns-right' : title.length, 'uni-navbar__header-is-right-btns': rightBtn}  " @tap="onClickRight" class="uni-navbar__header-btns right-solt uni-navbar__content_view">
...
<style lang="scss" scoped>
	...
	.uni-navbar__header-is-right-btns{
		width: 130rpx;
		margin-right: 20rpx;
	}
</style>
